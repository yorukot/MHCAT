        ...
        try {
            ...
            coin.find({
                ...
                img.then((img) => {
                    ...
                    .addComponents(
                        new ButtonBuilder()
                        .setCustomId(`[${interaction.member.id}]{${number - 10}}coin_rank`)
                        .setEmoji("<:lefft:1079286176332136480>")
                        .setStyle(ButtonStyle.Success)
                        .setDisabled(number - 10 < 0 ? true : false),
                        new ButtonBuilder()
                        .setCustomId(`[${interaction.member.id}]{${number - 1}}coin_rank`)
                    ...
                    .addComponents(
                        ...
                        .setDisabled(true),
                        new ButtonBuilder()
                        .setCustomId(`[${interaction.member.id}]coin_rank {${Math.trunc(get_coin_rank_number() / 10)}}`)
